...
/**
 * The Main WC_MNM_APFS_Subscription_Switching class
 **/
if ( ! class_exists( 'WC_MNM_APFS_Subscription_Switching' ) ) :

	class WC_MNM_APFS_Subscription_Switching {
		...
		*/
		...
		/**
		 * Child items inherit the active subscription scheme id of their parent.
		 *
		 * @param  string  $scheme_key
		 * @param  array   $cart_item
		...
		*/
		...
		public static function set_child_items_scheme( $child_items, $container ) {
			...
			if ( ! empty( $child_items ) && $container->is_synced() ) {
